...
public class SportNews extends Fragment implements LoaderManager.LoaderCallbacks<List<NewsInfo>> {

    private static final String NEWS_URL = "https://newsapi.org/v2/top-headlines?" +
            "country=ng&category=sports&apiKey=8bd6245749de492ba64956f4132143db";

    private static final int NEWSFEED_LOADER_ID = 5;
    ...
    private void checkNetwork() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (loaderManager.getLoader(NEWSFEED_LOADER_ID) == null) {
                loaderManager.initLoader(NEWSFEED_LOADER_ID, null, SportNews.this);
            } else {
                loaderManager.restartLoader(NEWSFEED_LOADER_ID, null, SportNews.this);
            }
        } else {
